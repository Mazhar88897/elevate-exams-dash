            ...
            <CardContent>
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="pt-2">
                    <Button type="submit" className="w-full rounded-mid bg-purple-600 hover:bg-purple-700" disabled={loading}>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@.com" className="text-sm text-purple-600 hover:underline">
                      support@elevate.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+18001234567" className="text-sm text-purple-600 hover:underline">
                      +1 (800) 123-4567
                    </a>
                  </div>
                </div>
              ...
              <CardContent>
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1">
                    <AccordionTrigger className="text-xs font-medium">How do I reset my password?</AccordionTrigger>
                  ...
                  <AccordionItem value="item-2">
                    <AccordionTrigger className="text-xs font-medium">Where are my certificates?</AccordionTrigger>
                    <AccordionContent className="text-xs text-gray-600">
