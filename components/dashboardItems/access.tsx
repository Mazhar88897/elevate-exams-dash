  ...
  return (
    <div>
       <div className="bg-[#EADAFF]   rounded-mid px-3 py-2 mb-8 flex flex-col sm:flex-row items-center justify-between">
          ...
          <Button className="bg-purple-700 hidden sm:block hover:bg-purple-800 w-full text-sm font-bold dark:text-white sm:w-auto rounded-mid">Unlock Access</Button>
        </div>
    </div>
  )
}
